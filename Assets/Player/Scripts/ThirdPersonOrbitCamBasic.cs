...
public class ThirdPersonOrbitCamBasic : MonoBehaviour 
{
	...
	public Vector3 pivotOffset = new Vector3(0.0f, 0.8f,  0.0f);       // Offset to repoint the camera.
	public Vector3 camOffset   = new Vector3(0f, 0f, 0f);       // Offset to relocate the camera related to the player position.
